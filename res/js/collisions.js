import { player, platforms, spikes, estus, estusPosition, enemy, enemy2, enemy3 } from "./main.js";
...
export function estusCollision(){
    if(player.y + player.height + player.velocityY >= estus.y && player.x + player.width >= estus.x &&
      player.y <= estus.y + estus.height && player.x <= estus.x + estus.width) estusPosition(), score++, pickUp = true;
    else pickUp = false;  
